...
public class NewMasterDetailForm extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("crudPU").createEntityManager();
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM Tabla1 t");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<crud.Tabla1> toRemove = new ArrayList<crud.Tabla1>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            crud.Tabla1 t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<crud.Tabla1> merged = new ArrayList<crud.Tabla1>(list.size());
            for (crud.Tabla1 t : list) {
    ...
    private java.util.List<crud.Tabla1> list;
